...
class ChatroomConsumer(WebsocketConsumer):
    ...
    def update_online_count(self):
        online_users = self.chatroom.users_online.exclude(id=self.user.id)
...
class OnlineStatusConsumer(WebsocketConsumer):
    def connect(self):
        ...
        # Ensure user is added to the public chat's online list
    ...
    def disconnect(self, close_code):
        # Ensure user is removed from the public chat's online list when they leave
